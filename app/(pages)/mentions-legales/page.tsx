      ...
      <div id="jumbotron" className="jumbotron-custom mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p>
              Le directeur de publication est le propriétaire de <span className="font-bold">{siteData.shop.name}</span>.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              L’ensemble du contenu présent sur ce site (textes, images, graphismes, logo, etc.) est la propriété exclusive de <span className="font-bold">{siteData.shop.name}</span>, sauf mention contraire.
            </p>
          </section>
